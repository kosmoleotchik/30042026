          ...
          <div className="contact__grid">
            ...
            <div className="contact__right">
              ...
              <label className="consent">
                ...
                <span>
                  Я даю согласие на обработку своих персональных данных и подтверждаю, что ознакомлен(а) с <a href="#" className="inline-link">Политикой обработки персональных данных</a>.
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__grid">
          ...
          <div>
            ...
            <div className="footer__contacts">
              ...
              <div style={{color:'var(--footer-ink-muted)', fontSize:13, marginTop: 4}}>Режим работы: круглосуточно, без выходных</div>
        ...
        <div className="footer__bottom">
          <div>© 2024–2026 г. <a href="#">Политика конфиденциальности</a></div>
          <div>ИП Стрелков Родион Александрович · ИНН 091706875564 · ОГРНИП 325010000032740</div>
        </div>
      </div>
    </footer>
  );
